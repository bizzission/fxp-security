...
use Sonatra\Component\Security\Listener\AclExceptionListener;
 ...
 */
class AclExceptionListenerTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testKernelException()
    {
        ...
        $listener = new AclExceptionListener();
